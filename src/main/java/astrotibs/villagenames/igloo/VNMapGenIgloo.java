...
public class VNMapGenIgloo extends MapGenStructure
{
    ...
    protected static boolean canSpawnStructureAtCoords(World worldIn, int chunkX, int chunkZ)
    {
        ...
        if (k == i1 && l == j1)
        {
            BiomeGenBase biomegenbase = worldIn.getWorldChunkManager().getBiomeGenerator(new BlockPos(k * 16 + 8, 0, l * 16 + 8));//this.worldObj.getWorldChunkManager().getBiomeGenAt(k * 16 + 8, l * 16 + 8);
    ...
    public boolean func_175798_a(BlockPos pos)
    {
