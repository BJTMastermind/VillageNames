...
public class MathHelper1122 extends MathHelper

/*
 * This is the net.minecraft.util.math.MathHelper from 1.12.2
 */

{
     ...
     */
    public static float sin_1122(float value)
    {
     ...
     */
    public static float cos_1122(float value)
    {
