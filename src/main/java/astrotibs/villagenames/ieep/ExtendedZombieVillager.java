...
public class ExtendedZombieVillager implements IExtendedEntityProperties
{
    ...
    public void pickRandomProfessionAndCareer() {
        if (this.profession <= -1 && this.career <= -1 && (this.hasValidData == null || !this.hasValidData)) {
            ...
            int c = -1;
				...
				case 1: // LIBRARIAN
					c = 1 + (GeneralConfig.modernVillagerTrades ? this.myWorld.rand.nextInt(2) : 0); // Cartographer
					break;
				...
				case 3: // BLACKSMITH
					c = 1 + this.myWorld.rand.nextInt(GeneralConfig.modernVillagerTrades ? 4 : 3); // Mason
					break;
    ...
    public void saveNBTData(NBTTagCompound compound) {
        ...
        properties.setInteger(professionLevelKey, this.professionLevel);
