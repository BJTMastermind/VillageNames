...
public class BannerGenerator {
	...
	public static Object[] getVillageBannerData(EntityVillager villager)
	{
		...
		if (!villager.world.isRemote)
		{
			...
			Village villageNearTarget = villager.world.villageCollectionObj.getNearestVillage(villager.getPosition(), EntityInteractHandler.villageRadiusBuffer);
			...
			if (villageNearTarget != null)
			{
		        ...
		        while(itr.hasNext()) { // Going through the list of VN villages
		            ...
		            Village villageNearSign = villager.world.villageCollectionObj.getNearestVillage(new BlockPos(townX, townY, townZ), EntityInteractHandler.villageRadiusBuffer);
