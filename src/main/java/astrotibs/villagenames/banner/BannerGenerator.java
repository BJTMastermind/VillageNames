...
public class BannerGenerator
{
	...
	public static Object[] getVillageBannerData(EntityLivingBase entity)
	{
		...
		if (!entity.world.isRemote)
		{
			...
			Village villageNearTarget = entity.world.villageCollectionObj.getNearestVillage(entity.getPosition(), EntityInteractHandler.villageRadiusBuffer);
			...
			if (villageNearTarget != null)
			{
		        ...
		        while(itr.hasNext()) { // Going through the list of VN villages
		            ...
		            Village villageNearSign = entity.world.villageCollectionObj.getNearestVillage(new BlockPos(townX, townY, townZ), EntityInteractHandler.villageRadiusBuffer);
