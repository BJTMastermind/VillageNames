...
public class ItemCodex extends Item {
	...
	//private final String name = "codex";
	...
	public ItemCodex() {
		...
		//setTextureName(Reference.MOD_ID.toLowerCase() + ":" + "codex"); // I don't know if we need this anymore
	}
    	...
    	try {
        	...
        	if (!world.isRemote) {
        		...
        		if (player.inventory.hasItemStack(new ItemStack(Items.BOOK))) {
            					...
            					if (nbtbase.getId() == 10) {
            						...
            						try {
            							...
            							if (
            								...
            								/*
            								player.addChatComponentMessage(new ChatComponentText( "You are inside a "+structureType
            										+ " called " + structureName
            										+ " at chunk X="+ChunkX+", Z="+ChunkZ) );
            								*/
        			...
        			//player.addChatComponentMessage(new ChatComponentText( nameRoot ) );
        			...
        			//Test characters here by plunking them into the book
        			//bookContents += "\n \u00a7r STUFF: ";
        			//bookContents += "\u0121 \u0120 \u0126 \u0128 \u00e2 \u00e0 \u0151 \u017e \u00fc";
        			...
        			if (signX!=-1 && signY!=-1 && signZ!=-1) {
            			...
            			//player.addChatComponentMessage(new ChatComponentText( "has book" ) );
        			...
        			//player.addChatComponentMessage(new ChatComponentText( "no book" ) );
        		}
        	}
