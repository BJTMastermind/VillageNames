...
public class ItemMonumentBook extends ItemWrittenBook {
	
	//private final String name = "monumentbook";
	
	public ItemMonumentBook() {
		super();
		this.setUnlocalizedName("monumentbook");
