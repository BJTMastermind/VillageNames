...
{
	public ConfigurationVN(File configFile) {super(configFile);}
	...
	public String[] getStringListWithoutDefaultsInComment(String name, String category, String[] defaultValue, String comment)
    {
        Property prop = this.get(category, name, defaultValue);
        prop.setLanguageKey(name);
