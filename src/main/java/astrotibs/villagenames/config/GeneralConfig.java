...
public class GeneralConfig {
	...
	protected static void loadConfiguration()
	{
	    ...
	    // --------------Professions-----------------//
	    treasureTrades = config.getBoolean("Treasure Trades", Reference.CATEGORY_VILLAGER_PROFESSIONS, true, "High-level Librarians will offer treasures in exchange for " + Reference.MOD_NAME + " items.");
	    ...
	    //villagerCareers = config.getBoolean("Villager Careers", Reference.CATEGORY_VILLAGER_PROFESSIONS, false, "Assign 1.8+ Career subdivisions to vanilla Professions. Trading is still 1.7 style, but merchant offers will be more progression-based. "
	    ...
	    modernVillagerTrades = config.getBoolean("Modern Villager Trades", Reference.CATEGORY_VILLAGER_PROFESSIONS, true, "Use JE 1.14 / BE 1.12 trade offerings and add the Cartographer and Mason villagers");
