...
public class GeneralConfigHandler {
	...
	private static void loadConfiguration() {
	    ...
	    nitwitProfession = config.getString("nitwitProfession", "Profession/Career", "", "The career displayed for a Nitwit. Blank this out to display no profession regardless of addJobToName.");
