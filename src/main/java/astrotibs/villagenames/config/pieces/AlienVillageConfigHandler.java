...
public class AlienVillageConfigHandler
{
	...
	{
		alienvillage_prefix = config.getString("Prefixes", "Alien Village Syllable Pool", NamePieces.alienvillage_prefix_default,
				"Prefixes that can occur before the core name.").trim().split("\\s*,\\s*");
		
		alienvillage_root_initial = config.getString("Root: Initial", "Alien Village Syllable Pool", NamePieces.alienvillage_root_initial_default,
				"Core names begin with one of these half-syllables. Use _ to represent a space.").trim().split("\\s*,\\s*");
		
		alienvillage_root_syllables = config.getString("Root: Syllables", "Alien Village Syllable Pool", NamePieces.alienvillage_root_sylBegin_default,
		...
		alienvillage_root_terminal = config.getString("Root: Terminal", "Alien Village Syllable Pool", NamePieces.alienvillage_root_terminal_default,
