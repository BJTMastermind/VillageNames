...
public class MapGenVillageVN extends MapGenVillage
{
	...
	{
		if (event.getType() == EventType.VILLAGE && GeneralConfig.newVillageGenerator)
        {
    ...
    {
        return new MapGenVillageVN.Start(this.world, this.rand, chunkX, chunkZ, this.terrainType);
    }
