...
public class StructureCreationHandlers
{
	...
	public static class PlainsAccessory1_Handler implements IVillageCreationHandler
	{
	    ...
	    {
	    	double weightDouble = ali.get(0); int weightStochastic = MathHelper.floor(weightDouble) + (random.nextDouble()<(weightDouble%1) ? 1:0);
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsAccessory1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    {
	    	if (startPiece instanceof StartVN) {return PlainsAccessory1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	...
	public static class PlainsAnimalPen1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double weightDouble = ali.get(0); int weightStochastic = (VillageGeneratorConfigHandler.villageAnimalRestrictionLevel<3) ? MathHelper.floor(weightDouble) + (random.nextDouble()<(weightDouble%1) ? 1:0) : 0;
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsAnimalPen1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsAnimalPen1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsAnimalPen2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsAnimalPen2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsAnimalPen2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsAnimalPen3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsAnimalPen3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsAnimalPen3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsArmorerHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsArmorerHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsArmorerHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsBigHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsBigHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsBigHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsButcherShop1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsButcherShop1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsButcherShop1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsButcherShop2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsButcherShop2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsButcherShop2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsCartographer1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsCartographer1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsCartographer1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsFisherCottage1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsFisherCottage1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsFisherCottage1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsFletcherHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsFletcherHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsFletcherHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsLargeFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsLargeFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsLargeFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsLibrary1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsLibrary1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsLibrary1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsLibrary2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsLibrary2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsLibrary2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsMasonsHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsMasonsHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsMasonsHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsMediumHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsMediumHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsMediumHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsMediumHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsMediumHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsMediumHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsMeetingPoint4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsMeetingPoint4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsMeetingPoint4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsMeetingPoint5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsMeetingPoint5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsMeetingPoint5.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsShepherdsHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsShepherdsHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsShepherdsHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse5.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse6_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse6.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse6.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse7_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse7.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse7.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsSmallHouse8_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsSmallHouse8.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsSmallHouse8.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsStable1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsStable1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsStable1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsStable2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsStable2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsStable2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsTannery1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsTannery1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsTannery1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsTemple3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsTemple3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsTemple3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsTemple4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsTemple4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsTemple4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsToolSmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsToolSmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsToolSmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsWeaponsmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsWeaponsmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsWeaponsmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class PlainsStreetDecor1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(PlainsStreetDecor1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return PlainsStreetDecor1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertAnimalPen1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertAnimalPen1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertAnimalPen1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertAnimalPen2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertAnimalPen2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertAnimalPen2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertArmorer1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertArmorer1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertArmorer1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertButcherShop1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertButcherShop1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertButcherShop1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertCartographerHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertCartographerHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertCartographerHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertFarm2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertFarm2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertFarm2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertFisher1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertFisher1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertFisher1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertFletcherHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertFletcherHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertFletcherHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertLargeFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertLargeFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertLargeFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertLibrary1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertLibrary1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertLibrary1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertMason1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertMason1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertMason1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertMediumHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertMediumHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertMediumHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertMediumHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertMediumHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertMediumHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertShepherdHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertShepherdHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertShepherdHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse5.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse6_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse6.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse6.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse7_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse7.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse7.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertSmallHouse8_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertSmallHouse8.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertSmallHouse8.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertTannery1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertTannery1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertTannery1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertTemple1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertTemple1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertTemple1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertTemple2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertTemple2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertTemple2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertToolSmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertToolSmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertToolSmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertWeaponsmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertWeaponsmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertWeaponsmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertStreetDecor1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertStreetDecor1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertStreetDecor1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertStreetSubstitute1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertStreetSubstitute1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertStreetSubstitute1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertStreetSubstitute2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertStreetSubstitute2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertStreetSubstitute2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class DesertStreetSubstitute3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(DesertStreetSubstitute3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return DesertStreetSubstitute3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaAnimalPen1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaAnimalPen1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaAnimalPen1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaArmorer2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaArmorer2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaArmorer2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaArmorerHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaArmorerHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaArmorerHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaButcherShop1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaButcherShop1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaButcherShop1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaCartographerHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaCartographerHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaCartographerHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaFisherCottage1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaFisherCottage1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaFisherCottage1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaFletcherHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaFletcherHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaFletcherHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaLargeFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaLargeFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaLargeFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaLargeFarm2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaLargeFarm2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaLargeFarm2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaLibrary1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaLibrary1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaLibrary1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaMasonsHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaMasonsHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaMasonsHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaMediumHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaMediumHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaMediumHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaMediumHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaMediumHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaMediumHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaMediumHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaMediumHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaMediumHouse3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaMediumHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaMediumHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaMediumHouse4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaShepherdsHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaShepherdsHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaShepherdsHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaSmallFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaSmallFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaSmallFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaSmallHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaSmallHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaSmallHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaSmallHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaSmallHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaSmallHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaSmallHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaSmallHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaSmallHouse3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaSmallHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaSmallHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaSmallHouse4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaSmallHouse5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaSmallHouse5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaSmallHouse5.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaTannery1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaTannery1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaTannery1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaTemple1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaTemple1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaTemple1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaToolSmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaToolSmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaToolSmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaWeaponsmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaWeaponsmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaWeaponsmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaWeaponsmith2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaWeaponsmith2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaWeaponsmith2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class TaigaStreetDecor1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(TaigaStreetDecor1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return TaigaStreetDecor1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaAnimalPen1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaAnimalPen1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaAnimalPen1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaAnimalPen2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaAnimalPen2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaAnimalPen2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaAnimalPen3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaAnimalPen3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaAnimalPen3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaArmorer1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaArmorer1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaArmorer1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaButchersShop1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaButchersShop1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaButchersShop1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaButchersShop2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaButchersShop2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaButchersShop2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaCartographer1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaCartographer1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaCartographer1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaFisherCottage1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaFisherCottage1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaFisherCottage1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaFletcherHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaFletcherHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaFletcherHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaLargeFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaLargeFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaLargeFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaLargeFarm2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaLargeFarm2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaLargeFarm2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaLibrary1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaLibrary1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaLibrary1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaMason1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaMason1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaMason1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaMediumHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaMediumHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaMediumHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaMediumHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaMediumHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaMediumHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaShepherd1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaShepherd1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaShepherd1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallFarm_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallFarm.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallFarm.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse5.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse6_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse6.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse6.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse7_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse7.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse7.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaSmallHouse8_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaSmallHouse8.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaSmallHouse8.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaTannery1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaTannery1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaTannery1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaTemple1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaTemple1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaTemple1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaTemple2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaTemple2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaTemple2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaToolSmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaToolSmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaToolSmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaWeaponsmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaWeaponsmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaWeaponsmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaWeaponsmith2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaWeaponsmith2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaWeaponsmith2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaStreetDecor1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaStreetDecor1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaStreetDecor1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaStreetSubstitute1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaStreetSubstitute1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaStreetSubstitute1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaStreetSubstitute2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaStreetSubstitute2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaStreetSubstitute2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaStreetSubstitute3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaStreetSubstitute3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaStreetSubstitute3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SavannaStreetSubstitute4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SavannaStreetSubstitute4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SavannaStreetSubstitute4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyAnimalPen1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyAnimalPen1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyAnimalPen1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyAnimalPen2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyAnimalPen2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyAnimalPen2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyArmorerHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyArmorerHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyArmorerHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyArmorerHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyArmorerHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyArmorerHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyButchersShop1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyButchersShop1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyButchersShop1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyButchersShop2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyButchersShop2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyButchersShop2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyCartographerHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyCartographerHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyCartographerHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyFarm1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyFarm1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyFarm1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyFarm2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyFarm2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyFarm2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyFisherCottage_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyFisherCottage.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyFisherCottage.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyFletcherHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyFletcherHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyFletcherHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyLibrary1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyLibrary1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyLibrary1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyMasonsHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyMasonsHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyMasonsHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyMasonsHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyMasonsHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyMasonsHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyMediumHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyMediumHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyMediumHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyMediumHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyMediumHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyMediumHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyMediumHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyMediumHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyMediumHouse3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyShepherdsHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyShepherdsHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyShepherdsHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse2.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse3.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse4.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse5.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse6_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse6.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse6.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse7_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse7.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse7.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowySmallHouse8_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowySmallHouse8.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowySmallHouse8.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyTannery1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyTannery1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyTannery1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyTemple1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyTemple1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyTemple1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyToolSmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyToolSmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyToolSmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyWeaponSmith1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyWeaponSmith1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyWeaponSmith1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class SnowyStreetDecor1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SnowyStreetDecor1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	    ...
	    public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing coordBaseMode, int componentType)
	    {
	    	if (startPiece instanceof StartVN) {return SnowyStreetDecor1.buildComponent((StartVN)startPiece, pieces, random, x, y, z, coordBaseMode, componentType);} return null;
	    }
	}
	...
	public static class JungleArmorerHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleArmorerHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleButcherShop_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleButcherShop.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleCartographerHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleCartographerHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleCartographerHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleCartographerHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleFisherCottage_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleFisherCottage.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleFletcherHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleFletcherHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleFletcherHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleFletcherHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleLargeHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleLargeHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleLibrary_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleLibrary.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleMasonHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleMasonHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleMediumHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleMediumHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleMediumHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleMediumHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleMediumHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleMediumHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleMediumHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleMediumHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleShepherdHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleShepherdHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse6_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse6.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse7_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse7.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSmallHouse8_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSmallHouse8.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleStable_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleStable.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleSteppedFarm_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleSteppedFarm.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleStoneAnimalPen_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleStoneAnimalPen.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleTamedFarm_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleTamedFarm.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleTannery1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleTannery1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleTannery2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleTannery2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleTemple_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleTemple.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleToolSmithy1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleToolSmithy1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleToolSmithy2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleToolSmithy2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleWeaponSmithy_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleWeaponSmithy.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleWildFarm_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleWildFarm.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleWoodAnimalPen_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleWoodAnimalPen.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleStreetDecor_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleStreetDecor.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleRoadAccent1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleRoadAccent1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class JungleRoadAccent2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(JungleRoadAccent2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampAnimalPen1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampAnimalPen1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampAnimalPen2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampAnimalPen2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampArmorerHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampArmorerHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampButcherShop_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampButcherShop.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampCartographerHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampCartographerHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampFisherCottage1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampFisherCottage1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampFisherCottage2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampFisherCottage2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampFletcherHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampFletcherHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampHutFarm_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampHutFarm.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampHorribleSecret_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampHorribleSecret.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampLargeHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampLargeHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampLibrary_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampLibrary.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampMasonHouse_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampMasonHouse.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampMediumHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampMediumHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampMediumHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampMediumHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampShepherdHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampShepherdHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampShepherdHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampShepherdHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampSmallHouse1_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampSmallHouse1.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampSmallHouse2_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampSmallHouse2.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampSmallHouse3_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampSmallHouse3.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampSmallHouse4_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampSmallHouse4.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampSmallHouse5_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampSmallHouse5.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampStable_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampStable.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampTannery_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampTannery.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampTemple_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampTemple.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampToolSmithy_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampToolSmithy.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampWeaponSmithy_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampWeaponSmithy.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampWildFarm_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampWildFarm.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampStreetDecor_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampStreetDecor.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
	...
	public static class SwampRoadAccent_Handler implements IVillageCreationHandler
	{
	    ...
	    public PieceWeight getVillagePieceWeight(Random random, int villageSize)
	    {
	    	...
	    	double lowerLimitDouble = villageSize * ali.get(1) + ali.get(2); int lowerLimitStochastic = MathHelper.floor(lowerLimitDouble) + (random.nextDouble()<(lowerLimitDouble%1) ? 1:0);
	    	double upperLimitDouble = villageSize * ali.get(3) + ali.get(4); int upperLimitStochastic = MathHelper.floor(upperLimitDouble) + (random.nextDouble()<(upperLimitDouble%1) ? 1:0);
	    	return new PieceWeight(SwampRoadAccent.class, weightStochastic, MathHelper.getInt(random, lowerLimitStochastic, upperLimitStochastic));
	    }
