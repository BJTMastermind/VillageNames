    ...
    */
    ...
    public static class DecorTorch extends StructureVillagePieces.Village
    {
        ...
        public DecorTorch(StartVN start, int componentType, Random random, StructureBoundingBox structureBB, EnumFacing coordBaseMode)
        {
            ...
            this.villageType = FunctionsVN.VillageType.getVillageTypeFromBiome(start.getBiomeProvider(), averageX, averageZ);
            this.materialType = FunctionsVN.MaterialType.getMaterialTemplateForBiome(start.getBiomeProvider(), averageX, averageZ);
        }
