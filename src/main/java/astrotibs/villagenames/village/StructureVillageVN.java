...
public class StructureVillageVN
{
    public static List getStructureVillageWeightedPieceList(Random random, int villageSize, FunctionsVN.VillageType villageType)
    {
        ...
        if (GeneralConfig.componentLegacyField2_vals.get(0)>0) {arraylist.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.Field2.class, GeneralConfig.componentLegacyField2_vals.get(0), MathHelper.getInt(random, villageSize * GeneralConfig.componentLegacyField1_vals.get(1) + GeneralConfig.componentLegacyField1_vals.get(2), villageSize * GeneralConfig.componentLegacyField1_vals.get(3) + GeneralConfig.componentLegacyField1_vals.get(4))));}
        if (GeneralConfig.componentLegacyHouse2_vals.get(0)>0) {arraylist.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.House2.class, GeneralConfig.componentLegacyHouse2_vals.get(0), MathHelper.getInt(random, villageSize * GeneralConfig.componentLegacyHouse2_vals.get(1) + GeneralConfig.componentLegacyHouse2_vals.get(2), villageSize * GeneralConfig.componentLegacyHouse2_vals.get(3) + GeneralConfig.componentLegacyHouse2_vals.get(4))));}
        if (GeneralConfig.componentLegacyHouse3_vals.get(0)>0) {arraylist.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.House3.class, GeneralConfig.componentLegacyHouse3_vals.get(0), MathHelper.getInt(random, villageSize * GeneralConfig.componentLegacyHouse3_vals.get(1) + GeneralConfig.componentLegacyHouse3_vals.get(2), villageSize * GeneralConfig.componentLegacyHouse3_vals.get(3) + GeneralConfig.componentLegacyHouse3_vals.get(4))));}
    ...
    public static StructureComponent getNextVillageStructureComponent(StartVN start, List<StructureComponent> components, Random random, int x, int y, int z, EnumFacing facing, int componentType)
    {
        ...
        else if (Math.abs(x - start.getBoundingBox().minX) <= 112 && Math.abs(z - start.getBoundingBox().minZ) <= 112)
        {
            ...
            if (structurecomponent != null)
            {
                ...
                Biome biome = start.worldChunkMngr.getBiome(new BlockPos(medianX, 0, medianZ));
    ...
    */
    ...
    public static class DecorTorch extends StructureVillagePieces.Village
    {
        ...
        public DecorTorch(StartVN start, int componentType, Random random, StructureBoundingBox structureBB, EnumFacing coordBaseMode)
        {
            ...
            this.villageType = FunctionsVN.VillageType.getVillageTypeFromBiome(start.worldChunkMngr, averageX, averageZ);
            this.materialType = FunctionsVN.MaterialType.getMaterialTemplateForBiome(start.worldChunkMngr, averageX, averageZ);
        }
