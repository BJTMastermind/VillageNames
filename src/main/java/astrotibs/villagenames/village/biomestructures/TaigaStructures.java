...
public class TaigaStructures
{
    ...
    public static class TaigaMeetingPoint1 extends StructureVillageVN.StartVN
    {
    	...
    	public TaigaMeetingPoint1(BiomeProvider biomeProvider, int componentType, Random random, int posX, int posZ, List components, float terrainType)
    	{
	...
	public static class TaigaMeetingPoint2 extends StructureVillageVN.StartVN
    {
    	...
    	public TaigaMeetingPoint2(BiomeProvider biomeProvider, int componentType, Random random, int posX, int posZ, List components, float terrainType)
    	{
    		super(biomeProvider, componentType, random, posX, posZ, components, terrainType);
