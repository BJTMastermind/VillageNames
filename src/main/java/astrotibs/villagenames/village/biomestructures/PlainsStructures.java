...
public class PlainsStructures
{
            ...
            */
            ...
            for (int i : new int[]{3,4,5})
            {
                ...
                if (k > -1)
                {
                	...
                	StructureVillageVN.setPathSpecificBlock(world, this.materialType, this.biome, this.disallowModSubs, this.getXWithOffset(0, i+1), k, this.getZWithOffset(0, i+1));
               	}
                ...
                if (k > -1)
                {
                	...
                	StructureVillageVN.setPathSpecificBlock(world, this.materialType, this.biome, this.disallowModSubs, this.getXWithOffset(9, i), k, this.getZWithOffset(9, i));
               	}
                ...
                if (k > -1)
                {
                	...
                	StructureVillageVN.setPathSpecificBlock(world, this.materialType, this.biome, this.disallowModSubs, this.getXWithOffset(i, 0), k, this.getZWithOffset(i, 0));
               	}
                ...
                if (k > -1)
                {
                	...
                	StructureVillageVN.setPathSpecificBlock(world, this.materialType, this.biome, this.disallowModSubs, this.getXWithOffset(i+1, 9), k, this.getZWithOffset(i+1, 9));
               	}
            }
    ...
    public static class PlainsMeetingPoint2 extends StartVN
    {
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	...
        	{
        		StructureVillageVN.setPathSpecificBlock(world, this.materialType, this.biome, this.disallowModSubs, this.getXWithOffset(offset_xy[0], offset_xy[1]), this.getYWithOffset(0), this.getZWithOffset(offset_xy[0], offset_xy[1]));
        	}
