...
public class SavannaStructures
{
    ...
    public static class SavannaMeetingPoint1 extends StartVN
    {
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			if (this.coordBaseMode.getHorizontalIndex()%2!=1) {StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()==0 ? 5 : this.coordBaseMode.getHorizontalIndex()==2 ? 4 : 0), this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());}
			// Eastward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()==1 || this.coordBaseMode.getHorizontalIndex()==2 ? 5 : 4), EnumFacing.EAST, this.getComponentType());
			// Southward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()==1 || this.coordBaseMode.getHorizontalIndex()==2 ? 5 : 4), this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
			if (this.coordBaseMode.getHorizontalIndex()%2!=0) {StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()==1 ? 4 : 5), EnumFacing.WEST, this.getComponentType());}
		}
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
			...
			})
			{
				...
				world.setBlockState(new BlockPos(bannerX, bannerY, bannerZ), Blocks.wall_banner.getStateFromMeta(StructureVillageVN.getSignRotationMeta(uvwoc[3], this.coordBaseMode.getHorizontalIndex(), true)), 2);
				
				// Set the tile entity
				TileEntity tilebanner = new TileEntityBanner();
				NBTTagCompound modifystanding = new NBTTagCompound();
				tilebanner.writeToNBT(modifystanding);
				modifystanding.setInteger("Base", 15 - (GeneralConfig.decorateVillageCenter ? uvwoc[4] : 12));
    ...
    public static class SavannaMeetingPoint2 extends StartVN
    {
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + 4, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			// Eastward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 4, EnumFacing.EAST, this.getComponentType());
			// Southward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + 4, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 4, EnumFacing.WEST, this.getComponentType());
		}
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	...
        	// Set rim
        	this.fillWithBlocks(world, structureBB, 3, 1, 4, 7, 1, 6, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor2 : 1), Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor2 : 1), false);
        	this.fillWithBlocks(world, structureBB, 4, 1, 3, 6, 1, 7, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor2 : 1), Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor2 : 1), false);
        	// Set water
        	...
        	// Set spire
        	this.fillWithBlocks(world, structureBB, 5, 1, 5, 5, 5, 5, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), false);
        	// Place individual clay blocks here and there
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 1, 1, 1, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 9, 1, 1, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 9, 1, 9, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 1, 1, 9, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 5, 1, 3, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 5, 1, 7, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 3, 1, 5, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 7, 1, 5, structureBB);
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor2 : 1), 5, 4, 5, structureBB);
    ...
    public static class SavannaMeetingPoint3 extends StartVN
    {
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 3 : 4), this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			// Eastward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 4 : 3), EnumFacing.EAST, this.getComponentType());
			// Southward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 3 : 4), this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
			StructureVillageVN.getNextComponentVillagePath((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 4 : 3), EnumFacing.WEST, this.getComponentType());
		}
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	...
        	// Sign support
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 4, 3, 5, structureBB);
    ...
    public static class SavannaMeetingPoint4 extends StartVN
    {
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
    		...
    		if (GeneralConfig.decorateVillageCenter)
    		{
            	...
            	// Set the banner and its orientation
				world.setBlockState(new BlockPos(bannerX, bannerY, bannerZ), Blocks.standing_banner.getStateFromMeta(StructureVillageVN.getSignRotationMeta(12, this.coordBaseMode.getHorizontalIndex(), false)), 2);
        	...
        	// Sign support
        	this.setBlockState(world, Blocks.stained_hardened_clay.getStateFromMeta(GeneralConfig.decorateVillageCenter ? townColor : 4), 4, 3, 4, structureBB);
