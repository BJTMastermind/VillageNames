...
public class SavannaStructures
{
    ...
    public static class SavannaMeetingPoint1 extends StructureVillageVN.StartVN
    {
		...
		public SavannaMeetingPoint1(WorldChunkManager chunkManager, int componentType, Random random, int posX, int posZ, List components, float terrainType)
		{
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			if (this.coordBaseMode.getHorizontalIndex()%2!=1) {StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()==0 ? 5 : this.coordBaseMode.getHorizontalIndex()==2 ? 4 : 0), this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());}
			// Eastward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()==1 || this.coordBaseMode.getHorizontalIndex()==2 ? 5 : 4), EnumFacing.EAST, this.getComponentType());
			// Southward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()==1 || this.coordBaseMode.getHorizontalIndex()==2 ? 5 : 4), this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
			if (this.coordBaseMode.getHorizontalIndex()%2!=0) {StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()==1 ? 4 : 5), EnumFacing.WEST, this.getComponentType());}
		}
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	if (this.field_143015_k < 0)
            {
        		this.field_143015_k = StructureVillageVN.getMedianGroundLevel(world,
        				...
        				true, (byte)13, this.coordBaseMode.getHorizontalIndex());
        	...
        	this.fillWithBlocks(world, structureBB, 1, 4, 5, 3, 4, 5, biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{2,1,3,0})[this.coordBaseMode.getHorizontalIndex()]), biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{2,1,3,0})[this.coordBaseMode.getHorizontalIndex()]), false);
        	this.fillWithBlocks(world, structureBB, 1, 4, 6, 3, 4, 6, biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{3,0,2,1})[this.coordBaseMode.getHorizontalIndex()]), biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{3,0,2,1})[this.coordBaseMode.getHorizontalIndex()]), false);
        	// Logs
        	...
        	this.fillWithBlocks(world, structureBB, 10, 4, 1, 10, 4, 3, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 0 : 2), biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 0 : 2), false);
        	this.fillWithBlocks(world, structureBB, 11, 4, 1, 11, 4, 3, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 1 : 3), biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 1 : 3), false);
        	// Logs
        	...
        	this.fillWithBlocks(world, structureBB, 10, 4, 8, 10, 4, 10, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 0 : 2), biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 0 : 2), false);
        	this.fillWithBlocks(world, structureBB, 11, 4, 8, 11, 4, 10, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 1 : 3), biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 1 : 3), false);
        	// Logs
    ...
    public static class SavannaMeetingPoint2 extends StructureVillageVN.StartVN
    {
		...
		public SavannaMeetingPoint2(WorldChunkManager chunkManager, int componentType, Random random, int posX, int posZ, List components, float terrainType)
		{
		    super(chunkManager, componentType, random, posX, posZ, components, terrainType);
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
            ...
            if (GeneralConfig.nameSign)
            {
    			...
    			world.setBlockState(new BlockPos(signX2, signY, signZ2), biomeStandingSignState.getBlock().getStateFromMeta(StructureVillageVN.getSignRotationMeta(4, this.coordBaseMode.getHorizontalIndex(), false)), 2); // 2 is "send change to clients without block update notification"
    ...
    public static class SavannaMeetingPoint3 extends StructureVillageVN.StartVN
    {
		...
		public SavannaMeetingPoint3(WorldChunkManager chunkManager, int componentType, Random random, int posX, int posZ, List components, float terrainType)
		{
		    super(chunkManager, componentType, random, posX, posZ, components, terrainType);
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 3 : 4), this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			// Eastward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 4 : 3), EnumFacing.EAST, this.getComponentType());
			// Southward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 3 : 4), this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + (this.coordBaseMode.getHorizontalIndex()%2==0 ? 4 : 3), EnumFacing.WEST, this.getComponentType());
		}
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	...
        	this.setBlockState(world, StructureVillageVN.getHorizontalPillarState(biomeLogState, this.coordBaseMode.getHorizontalIndex(), true), 4, 1, 2, structureBB);
        	this.setBlockState(world, StructureVillageVN.getHorizontalPillarState(biomeLogState, this.coordBaseMode.getHorizontalIndex(), true), 4, 1, 4, structureBB);
        	...
        	this.setBlockState(world, StructureVillageVN.getHorizontalPillarState(biomeLogState, this.coordBaseMode.getHorizontalIndex(), true), 4, 1, 6, structureBB);
        	this.setBlockState(world, StructureVillageVN.getHorizontalPillarState(biomeLogState, this.coordBaseMode.getHorizontalIndex(), true), 4, 1, 8, structureBB);
        	this.setBlockState(world, StructureVillageVN.getHorizontalPillarState(biomeLogState, this.coordBaseMode.getHorizontalIndex(), true), 4, 0, 7, structureBB);
    ...
    public static class SavannaMeetingPoint4 extends StructureVillageVN.StartVN
    {
		...
		public SavannaMeetingPoint4(WorldChunkManager chunkManager, int componentType, Random random, int posX, int posZ, List components, float terrainType)
		{
		    super(chunkManager, componentType, random, posX, posZ, components, terrainType);
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	...
        	// Roof
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{2,1,3,0})[this.coordBaseMode.getHorizontalIndex()]), 3, 4, 3, structureBB);
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{2,1,3,0})[this.coordBaseMode.getHorizontalIndex()]), 4, 4, 3, structureBB);
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 1 : 3), 5, 4, 3, structureBB);
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 1 : 3), 5, 4, 4, structureBB);
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{3,0,2,1})[this.coordBaseMode.getHorizontalIndex()]), 5, 4, 5, structureBB);
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta((new int[]{3,0,2,1})[this.coordBaseMode.getHorizontalIndex()]), 4, 4, 5, structureBB);
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 0 : 2), 3, 4, 5, structureBB);
        	this.setBlockState(world, biomeWoodenStairsState.getBlock().getStateFromMeta(this.coordBaseMode.getHorizontalIndex()%2==0 ? 0 : 2), 3, 4, 4, structureBB);
    		...
    		if (GeneralConfig.villageBanners)
    		{
            	...
            	// Set the banner and its orientation
				world.setBlockState(bannerPos, Blocks.standing_banner.getStateFromMeta(StructureVillageVN.getSignRotationMeta(12, this.coordBaseMode.getHorizontalIndex(), false)), 2);
    ...
    public static class SavannaAnimalPen1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFF",
        ...
        public SavannaAnimalPen1(StartVN start, int componentType, Random random, StructureBoundingBox boundingBox, EnumFacing coordBaseMode)
        {
        	...
        	if (this.biome==null) {this.biome = start.getWorldChunkManager().getBiomeGenerator(new BlockPos((boundingBox.minX + boundingBox.maxX)/2, 64, (boundingBox.minZ + boundingBox.maxZ)/2));}
    ...
    public static class SavannaAnimalPen2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"  FFFFFF     ",
    ...
    public static class SavannaAnimalPen3 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFF",
    ...
    public static class SavannaArmorer1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFF",
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	...
        	{
        		IBlockState tryGlazedTerracottaState = ModObjects.chooseModGlazedTerracottaState(uvwoc[4], StructureVillageVN.chooseGlazedTerracottaMeta(uvwoc[3], this.coordBaseMode));
    ...
    public static class SavannaButchersShop1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFFFF",
    ...
    public static class SavannaButchersShop2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFF",
        ...
        public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
        {
        	...
        	{
            	ChestGenHooks chestGenHook = ChestGenHooks.getInfo(Reference.VN_BUTCHER);
    ...
    public static class SavannaCartographer1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"         ",
    ...
    public static class SavannaFisherCottage1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFF",
    ...
    public static class SavannaFletcherHouse1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFFFF",
    ...
    public static class SavannaLargeFarm1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFF",
    ...
    public static class SavannaLargeFarm2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFF   FFF ",
    ...
    public static class SavannaLibrary1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"  FFFFFFFF",
    ...
    public static class SavannaMason1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"          ",
    ...
    public static class SavannaMediumHouse1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"    FFFFFFF    ",
    ...
    public static class SavannaMediumHouse2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"           ",
    ...
    public static class SavannaShepherd1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFFFF",
    ...
    public static class SavannaSmallFarm extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		" FFFFF",
    ...
    public static class SavannaSmallHouse1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFF",
    ...
    public static class SavannaSmallHouse2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFF",
    ...
    public static class SavannaSmallHouse3 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFF",
    ...
    public static class SavannaSmallHouse4 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFFF",
    ...
    public static class SavannaSmallHouse5 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFF",
    ...
    public static class SavannaSmallHouse6 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"   F   ",
    ...
    public static class SavannaSmallHouse7 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFF",
    ...
    public static class SavannaSmallHouse8 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"       ",
    ...
    public static class SavannaTannery1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFF",
    ...
    public static class SavannaTemple1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFF",
    ...
    public static class SavannaTemple2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"         ",
    ...
    public static class SavannaToolSmith1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"FFFFFFFFFFF",
    ...
    public static class SavannaWeaponsmith1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"  FFFFFFF",
    ...
    public static class SavannaWeaponsmith2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"             ",
    ...
    public static class SavannaStreetDecor1 extends StructureVillageVN.VNComponent
    {
    	// Here are values to assign to the bounding box
    ...
    public static class SavannaStreetSubstitute1 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"       FF   ",
    ...
    public static class SavannaStreetSubstitute2 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"          FF  ",
    ...
    public static class SavannaStreetSubstitute3 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		" FFF",
    ...
    public static class SavannaStreetSubstitute4 extends StructureVillageVN.VNComponent
    {
    	// Make foundation with blanks as empty air and F as foundation spaces
        private static final String[] foundationPattern = new String[]{
        		"  FFF      ",
	 ...
	 */
    public static ArrayList<BlueprintData> getRandomSavannaDecorBlueprint(MaterialType materialType, boolean disallowModSubs, BiomeGenBase biome, EnumFacing coordBaseMode, Random random)
	{
		int decorCount = 1;
		return getSavannaDecorBlueprint(random.nextInt(decorCount), materialType, disallowModSubs, biome, coordBaseMode, random);
	}
	public static ArrayList<BlueprintData> getSavannaDecorBlueprint(int decorType, MaterialType materialType, boolean disallowModSubs, BiomeGenBase biome, EnumFacing coordBaseMode, Random random)
	{
