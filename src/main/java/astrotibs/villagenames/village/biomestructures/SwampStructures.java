...
public class SwampStructures
{
    ...
    public static class SwampStatue extends StartVN
    {
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + new int[]{4,4,4,3}[this.getCoordBaseMode().getHorizontalIndex()], this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			// Eastward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + new int[]{2,4,5,4}[this.getCoordBaseMode().getHorizontalIndex()], EnumFacing.EAST, this.getComponentType());
			// Southward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + new int[]{4,5,4,2}[this.getCoordBaseMode().getHorizontalIndex()], this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + new int[]{3,4,4,4}[this.getCoordBaseMode().getHorizontalIndex()], EnumFacing.WEST, this.getComponentType());
		}
    ...
    public static class SwampPavilion extends StartVN
    {
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.getCoordBaseMode().getHorizontalIndex()<2 ? 2:3), this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			// Eastward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + (this.getCoordBaseMode().getHorizontalIndex()<2 ? 2:3), EnumFacing.EAST, this.getComponentType());
			// Southward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + (this.getCoordBaseMode().getHorizontalIndex()<2 ? 3:2), this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + (this.getCoordBaseMode().getHorizontalIndex()<2 ? 3:2), EnumFacing.WEST, this.getComponentType());
		}
    ...
    public static class SwampMonolith extends StartVN
    {
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Northward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + new int[]{5,4,4,5}[this.getCoordBaseMode().getHorizontalIndex()], this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
			// Eastward
    ...
    public static class SwampCartographerHouse extends StructureVillagePieces.Village
    {
    	...
    	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
    	{
    		...
    		{
    			this.replaceAirAndLiquidDownwards(world, darkPrismarineState, uvw[0], uvw[1], uvw[2], structureBB);
    		}
        	...
        	{
            	this.setBlockState(world, ModObjects.chooseModCartographyTableState(uvwo[3], this.getCoordBaseMode()), uvwo[0], uvwo[1], uvwo[2], structureBB);
            }
    ...
    public static class SwampFisherCottage2 extends StructureVillagePieces.Village
    {
    	...
    	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
    	{
    		...
    		{
    			this.replaceAirAndLiquidDownwards(world, biomeStrippedLogVertState, uvw[0], uvw[1], uvw[2], structureBB);
    		}
    ...
    public static class SwampFletcherHouse extends StructureVillagePieces.Village
    {
    	...
    	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
    	{
            ...
            // Fletching Table
        	// Orientation - 0:forward, 1:rightward, 2:backward (toward you), 3:leftward, -1:upright;
        	this.setBlockState(world, ModObjects.chooseModFletchingTableState(3, this.getCoordBaseMode()), 8, 4, 8, structureBB); 
...
//			LogHelper.info("HORRIBLE SECRET! At x " + (this.boundingBox.maxX+this.boundingBox.minX)/2 + " " + (this.boundingBox.maxZ+this.boundingBox.minZ)/2);
    ...
    public static class SwampMasonHouse extends StructureVillagePieces.Village
    {
    	...
    	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
    	{
    		...
    		{
    			this.setBlockState(world, Blocks.STONE_BRICK_STAIRS.getStateFromMeta(uvwo[3]%4+(uvwo[3]/4)*4), uvwo[0], uvwo[1], uvwo[2], structureBB);
    		}
    		...
    		// Concrete
    		IBlockState concreteBlockState = Blocks.CONCRETE.getStateFromMeta(GeneralConfig.useVillageColors ? townColor : 15); // Black
    		for(int[] uuvvww : new int[][]{
    			// Front wall
    		...
    		{
    			this.fillWithBlocks(world, structureBB, uuvvww[0], uuvvww[1], uuvvww[2], uuvvww[3], uuvvww[4], uuvvww[5], concreteBlockState, concreteBlockState, false);
    		}
        	...
        	// Stone Cutter
        	// Orientation:0=fore-facing (away from you); 1=right-facing; 2=back-facing (toward you); 3=left-facing
            this.setBlockState(world, ModObjects.chooseModStonecutterState(2, this.getCoordBaseMode()), 3, 1, 8, structureBB);
    ...
    public static class SwampShepherdHouse1 extends StructureVillagePieces.Village
    {
    	...
    	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
    	{
    		...
    		for (int[] uvwoor : new int[][] { { 6, 4, 7, 0, 1, 1 } }) {
    			for (int height = 0; height <= 1; height++)
    			{
    				setBlockState(world, biomeWoodDoorBlock.getStateFromMeta(StructureVillageVN.getDoorMetas(uvwoor[3], this.getCoordBaseMode(), (uvwoor[4] == 1), (uvwoor[5] == 1))[height]), uvwoor[0], uvwoor[1] + height, uvwoor[2], structureBB);
    			}
    		}
    		...
    		{
    			setBlockState(world, ModObjects.chooseModLoom(uvwo[3], this.getCoordBaseMode()), uvwo[0], uvwo[1], uvwo[2], structureBB);
    		}
	...
	public static class SwampShepherdHouse2 extends StructureVillagePieces.Village
	{
		...
		public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
		{
			...
			{
				this.setBlockState(world, ModObjects.chooseModLoom(uvwo[3], this.getCoordBaseMode()), uvwo[0], uvwo[1], uvwo[2], structureBB);
			}
    ...
    public static class SwampToolSmithy extends StructureVillagePieces.Village
    {
    	...
    	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
    	{
    		...
    		{
    			this.setBlockState(world, ModObjects.chooseModSmithingTable(uvwo[3], this.getCoordBaseMode()), uvwo[0], uvwo[1], uvwo[2], structureBB);
    		}
        	...
        	if (polishedAndesiteSlabUpperState==null) {polishedAndesiteSlabUpperState = ModObjects.chooseModAndesiteBrickSlabState(true);} // Try Andesite Brick stairs
        	Block polishedAndesiteStairsBlock = ModObjects.chooseModPolishedAndesiteStairsBlock();
        	if (polishedAndesiteStairsBlock==null) {polishedAndesiteStairsBlock = ModObjects.chooseModAndesiteBrickStairsBlock();} // Try Andesite Brick stairs
    		...
    		{
    			this.setBlockState(world, polishedAndesiteStairsBlock.getStateFromMeta(uvwo[3]%4+(uvwo[3]/4)*4), uvwo[0], uvwo[1], uvwo[2], structureBB);
    		}
