...
public class SwampStructures
{
    ...
    public static class SwampMonolith extends StructureVillageVN.StartVN
    {
		...
		public void buildComponent(StructureComponent start, List components, Random random)
		{
			...
			// Southward
			StructureVillageVN.generateAndAddRoadPiece((StructureVillagePieces.Start)start, components, random, this.boundingBox.minX + new int[]{4,5,5,4}[this.coordBaseMode.getHorizontalIndex()], this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
			// Westward
    ...
    public static class SwampHorribleSecret extends StructureVillageVN.VNComponent
    {
    	...
    	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBB)
    	{
            	...
            	})
            {
                ...
                {
                	world.setBlockState(pos, Blocks.dispenser.getStateFromMeta(StructureVillageVN.chooseFurnaceMeta(uvwo[3], this.coordBaseMode)), 2);
