...
public class EventTracker
{
    ...
    public EventTracker(EntityZombieVillager zombievillager, IModularSkin ims) { // Changed to IModularSkin in v3.1
    	this(
    			zombievillager.getEntityId(),
    			new Vec3i(zombievillager.posX, zombievillager.posY + 0.5D, zombievillager.posZ),
    			zombievillager.getCustomNameTag(), 	   			 // Added Object structure in v3.1
	   			new Object[] {
	   					ims.getProfession(),
	   					ims.getCareer(),
