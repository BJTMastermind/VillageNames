...
public class EventTracker
{
    ...
    public void updateZombie(EntityJoinWorldEvent event, IModularSkin ims) // Changed to IModularSkin in v3.1
    {
        ...
        if ( !customName.equals("") && !customName.equals(null)
        	...
        	zombie.enablePersistence(); //Equivalent to EntityLiving.enablePersistence() in 1.8
        }
        ...
        {
        	ims.setBiomeType(FunctionsVN.returnBiomeTypeForEntityLocation(zombie));
        }
        else
        {
        ...
        zombie.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, null);
