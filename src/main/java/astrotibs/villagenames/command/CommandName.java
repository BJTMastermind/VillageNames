		...
		if (!world.isRemote) {
			...
			for(int i = 0; i < numberToMake; i++) {
				...
				// Not a valid command choice
					...
					sender.addChatMessage( new TextComponentString("§c"+getCommandUsage(null) ) );
					break;
				}
				
			}
			sender.addChatMessage( new TextComponentString("") );
			sender.addChatMessage( new TextComponentString(nameType+":") );
			sender.addChatMessage( new TextComponentString(outputString) );
        } 
