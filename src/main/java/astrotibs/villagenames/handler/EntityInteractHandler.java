	...
	public void onEntityInteract(EntityInteract event)
	{
		...
		*/
		...
		if (
				...
				&& event.getEntity().world.villageCollectionObj.getNearestVillage(event.getEntity().getPosition(), villageRadiusBuffer) !=null
				) {
    ...
    public void onPlayerAttackEntity(AttackEntityEvent event) {
    	...
    	if (!event.getTarget().world.isRemote
        	...
        	if (event.getTarget() instanceof EntityVillager
        		...
        		Village villageNearTarget = target.world.villageCollectionObj.getNearestVillage(
