...
public class WriteBookHandler {
	...
	public static String makeSecondPage(EntityInteract event, String targetClassPath, Village villageNearVillager,
    	...
    	MapGenStructureData structureData = (MapGenStructureData)event.getEntityPlayer().worldObj.getPerWorldStorage().getOrLoadData(MapGenStructureData.class, "Village");
