...
public class AchievementReward {
	...
	public static void allFiveAchievements(EntityPlayerMP playerMP) {
		...
		if (
			      playerMP.getStatFile().hasAchievementUnlocked(VillageNames.archaeologist)
			   && playerMP.getStatFile().hasAchievementUnlocked(VillageNames.ghosttown)
			   && playerMP.getStatFile().hasAchievementUnlocked(VillageNames.laputa)
			   && playerMP.getStatFile().hasAchievementUnlocked(VillageNames.maxrep)
			   && playerMP.getStatFile().hasAchievementUnlocked(VillageNames.minrep)
				) {
