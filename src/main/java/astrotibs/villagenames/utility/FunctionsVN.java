...
public class FunctionsVN
{
	...
	public static enum VillageType
	{
		...
		public static VillageType getVillageTypeFromBiome(Biome biome)
		{
			...
			if (((String)(ReflectionHelper.getPrivateValue(Biome.class, biome, new String[]{"biomeName","field_76791_y"}))).toLowerCase().contains("jungle")) {return JUNGLE;}
			for (BiomeDictionary.Type type : typeTags) {if (type==BiomeDictionary.Type.JUNGLE) {return JUNGLE;}}
			if (((String)(ReflectionHelper.getPrivateValue(Biome.class, biome, new String[]{"biomeName","field_76791_y"}))).toLowerCase().contains("swamp")) {return SWAMP;}
	    					...
	    					case 4: // Expert
	    						...
	    						for (int i=0; i<buyingList.size(); i++)
	    						{
	    							...
	    							if (
	    								...
	    								moditemstack = ModObjects.chooseModSuspiciousStew(random);
	    								if (moditemstack != null)
	    								{
	    									buyingList.add(MathHelper.clamp(addToSlot++, 0, Math.max(buyingList.size()-1,0)), new MerchantRecipe(
		    										new ItemStack( Items.EMERALD, 1 ), new ItemStack( Item.getItemFromBlock(Blocks.AIR)), moditemstack, 0, 5
		    										));
	    								}
    				...
    				case 3: // Shepherd
    					...
    					switch (ims.getProfessionLevel())
    					{
	    					...
	    					case 3: // Journeyman
								...
								color1 = random.nextInt(16);
								buyingList.add(new MerchantRecipe(
										new ItemStack( Items.EMERALD, 3 ), new ItemStack( Item.getItemFromBlock(Blocks.AIR)), new ItemStack( Items.BED, 1, color1 ), 0, 5
										));
								if (random.nextBoolean())
								{
									buyingList.add(new MerchantRecipe(
											new ItemStack( Items.EMERALD, 3 ), new ItemStack( Item.getItemFromBlock(Blocks.AIR)), new ItemStack( Items.BED, 1, (color1+random.nextInt(15)+1)%16 ), 0, 5
											));
								}
    	...
    	while (true)
    	{
        	...
        	else if (career==2) // Cartographer
        	{
    			...
    			merchantRecipeArray.add( new MerchantRecipe( new ItemStack(ModItems.STRONGHOLD_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					new ItemStack(Items.ENDER_EYE, 2), 0, 2) );
    			...
    			merchantRecipeArray.add( new MerchantRecipe( new ItemStack(ModItems.FORTRESS_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.LONG_FIRE_RESISTANCE), 0, 2
    					));
    			...
    			merchantRecipeArray.add( new MerchantRecipe( new ItemStack(ModItems.SWAMP_HUT_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					PotionUtils.addPotionToItemStack(new ItemStack(Items.SPLASH_POTION), PotionTypes.STRONG_HARMING), 0, 2
    					));
    			merchantRecipeArray.add( new MerchantRecipe( new ItemStack(ModItems.SWAMP_HUT_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.STRONG_HEALING), 0, 2
    					));
    			...
    			merchantRecipeArray.add( new MerchantRecipe(new ItemStack(ModItems.MONUMENT_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.LONG_WATER_BREATHING), 0, 2
    					));
    			...
    			merchantRecipeArray.add( new MerchantRecipe(new ItemStack(ModItems.JUNGLE_TEMPLE_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.STRONG_STRENGTH), 0, 2
    					));
    			...
    			MerchantRecipe iglooForGoldenApple = new MerchantRecipe(new ItemStack(ModItems.IGLOO_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					new ItemStack(Items.GOLDEN_APPLE, 1), 0, 2
    					);
    			...
    			MerchantRecipe iglooForSplashWeakness = new MerchantRecipe(new ItemStack(ModItems.IGLOO_BOOK, 1), new ItemStack( Item.getItemFromBlock(Blocks.AIR)),
    					PotionUtils.addPotionToItemStack(new ItemStack(Items.SPLASH_POTION), PotionTypes.LONG_WEAKNESS), 0, 2
    					);
	...
	{
		Block block = Blocks.WHITE_GLAZED_TERRACOTTA;
		
		switch (colorMeta)
		{
		// Case 0 is handled by default
		case 1: block=Blocks.ORANGE_GLAZED_TERRACOTTA; break;
		case 2: block=Blocks.MAGENTA_GLAZED_TERRACOTTA; break;
		case 3: block=Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA; break;
		case 4: block=Blocks.YELLOW_GLAZED_TERRACOTTA; break;
		case 5: block=Blocks.LIME_GLAZED_TERRACOTTA; break;
		case 6: block=Blocks.PINK_GLAZED_TERRACOTTA; break;
		case 7: block=Blocks.GRAY_GLAZED_TERRACOTTA; break;
		case 8: block=Blocks.SILVER_GLAZED_TERRACOTTA; break;
		case 9: block=Blocks.CYAN_GLAZED_TERRACOTTA; break;
		case 10: block=Blocks.PURPLE_GLAZED_TERRACOTTA; break;
		case 11: block=Blocks.BLUE_GLAZED_TERRACOTTA; break;
		case 12: block=Blocks.BROWN_GLAZED_TERRACOTTA; break;
		case 13: block=Blocks.GREEN_GLAZED_TERRACOTTA; break;
		case 14: block=Blocks.RED_GLAZED_TERRACOTTA; break;
		case 15: block=Blocks.BLACK_GLAZED_TERRACOTTA; break;
		}
