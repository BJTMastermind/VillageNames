...
public class FunctionsVN
{
	...
	public static enum VillageType
	{
		...
		{
			Biome biome = worldChunkManager.getBiomeGenerator(new BlockPos(posX, 0, posZ));
			return getVillageTypeFromBiome(biome);
		}
    ...
    public static int pickRandomCareerForProfession(int profession, Random random)
    {
			...
			// Nitwit removed in 3.2: does not exist
		}
			return -1;
    }
					...
					case 1: // Butcher
		    			...
		    			switch (ims.getProfessionLevel())
						{
		    				...
		    				case 5: // Master
		    			    	...
		    			    	possibleHighButcherTrades.add(new MerchantRecipe( new ItemStack( Items.CHICKEN, Math.max(14 - ims.getProfessionLevel() + 1, 1) ), (ItemStack)null, new ItemStack( Items.EMERALD, 1 ), 0, 6) );
		    			    	possibleHighButcherTrades.add(new MerchantRecipe( new ItemStack( Items.RABBIT, Math.max(4 - ims.getProfessionLevel() + 1, 1) ), (ItemStack)null, new ItemStack( Items.EMERALD, 1 ), 0, 6) );
		    			    	possibleHighButcherTrades.add(new MerchantRecipe( new ItemStack( Items.PORKCHOP, Math.max(7 - ims.getProfessionLevel() + 1, 1) ), (ItemStack)null, new ItemStack( Items.EMERALD, 1 ), 0, 6) );
	...
	{
		Biome biome = entity.worldObj.getBiomeGenForCoords(entity.getPosition());
