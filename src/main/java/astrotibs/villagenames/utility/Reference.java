...
public class Reference
{
	...
	VERSION_CHECKER_URL = "https://gitgud.io/AstroTibs/VillageNames/raw/1.9.4/CURRENT_VERSION",
	MOD_CHANNEL = "vnChannel",
	CLIENT_PROXY = "astrotibs.villagenames.proxy.ClientProxy",
	SERVER_PROXY = "astrotibs.villagenames.proxy.ServerProxy",
	COMMON_PROXY = "astrotibs.villagenames.proxy.CommonProxy",
	GUI_FACTORY = "astrotibs.villagenames.config.gui.VNGuiFactory";
	...
	public static final
	String House4Garden_CLASS = "net.minecraft.world.gen.structure.StructureVillagePieces$House4Garden",
